...
document.addEventListener("DOMContentLoaded", function () {
  const logoInput = document.getElementById("logoFile"); // Correct ID from HTML
  const propertyImagesInput = document.getElementById("images"); // Correct ID from HTML
  const logoPreview = document.getElementById("logo-preview"); // Correct ID from HTML
  const propertyPreview = document.getElementById("image-preview"); // Correct ID from HTML
